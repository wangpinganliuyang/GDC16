 ...
 */
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x1008 = {DEFTYPE_VISIBLESTRING, 0x30, ACCESS_READ};
 ...
 */
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x1009 = {DEFTYPE_VISIBLESTRING,0x10, ACCESS_READ};
 ...
 * \brief 0x1009 (Hardware version) entry description
 */
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x100A = {DEFTYPE_VISIBLESTRING,0x20, ACCESS_READ};
...
OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x1C3x[] = {
   ...
   {0x0000, 0x20, 0}, /* SubIndex 003: Shift Time */
...
/*ECATCHANGE_START(V5.12) COE4*/
    UINT16 EscFeature = 0;
    EscFeature = ESC_readWordNonISR(ESC_FEATURES_OFFSET);
