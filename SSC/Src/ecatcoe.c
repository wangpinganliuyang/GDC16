...
//            MBXMEMCPY(pMbx, aSdoInfoHeader, SDO_INFO_HEADER_BYTE_SIZE);//修改
//            MBXMEMCPY(pMbx, aSdoInfoHeader, ((SDO_INFO_HEADER_BYTE_SIZE)>>1));//修改
        	//修改代码
        	...
        	//备注，aSdoInfoHeader，6字节邮箱头+2字节COE头+4字节SDO INFO头+2字节SDO list头
