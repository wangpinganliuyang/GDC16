...
#define     FRAGMENTS_FOLLOW                    ((UINT8) 0x0080) /**< \brief Fragments follow service*/
    ...
    #define    DISABLE_MBX_INT              __asm(" setc INTM")/**< \brief Disable mailbox interrupt*/
#endif
#ifndef ENABLE_MBX_INT
    #define    ENABLE_MBX_INT                __asm(" clrc INTM")/**< \brief Enable mailbox interrupt*/
#endif
...
/*ET9300 Project Handler :(#if MBX_16BIT_ACCESS #else) lines 109 to 122 deleted*/
